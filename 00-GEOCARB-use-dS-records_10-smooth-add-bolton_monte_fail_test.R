...
bolton <- read_excel('Bolton-O2.xlsx')

f_wr <- approxfun(bolton$PAL, bolton$Oxidized_percent)
...
if (Godderis == FALSE) {
  ...
  file_out <- paste0('GEOCARB_50%_sulfate_use-dS-record_10_smooth_add-boton-revision_monte_fail_test_', scenario, '.csv')
}
