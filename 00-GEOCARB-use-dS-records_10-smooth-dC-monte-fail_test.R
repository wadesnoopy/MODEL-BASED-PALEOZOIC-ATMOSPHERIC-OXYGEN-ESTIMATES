...
# time_arrays <- read.csv("GEOCARB_input_arrays_new_capS_error_0.csv")
...
if (Godderis == FALSE) {
  ...
  file_out <- paste0('GEOCARB_50%_sulfate_use-dS-record_10_smooth_revision_monte_fail_test_', scenario, '.csv')
}
