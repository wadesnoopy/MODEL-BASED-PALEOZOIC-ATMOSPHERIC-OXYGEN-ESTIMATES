...
input <- read.csv("GEOCARB_input_summaries_20%_sulfate.csv")
scenario = "smO2_lenton"
...
if (Godderis == FALSE) {
  ...
  file_out <- paste0('GEOCARB_20%_sulfate_forced_d13C_revision_monte_fail_test_', scenario, '.csv')
}
